...
import io.github.betterigo.job.core.TaskStatus;
...
//				dataMap.putAll(metaData);
			...
			JobDetail jobDetail = JobBuilder.newJob(RemoteFeignJob.class).usingJobData(dataMap).withIdentity(jobId,task.getGroupName()).build();
